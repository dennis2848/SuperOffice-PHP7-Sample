...
define('AUTH_URL',  'https://' . ENVIRONMENT . '.superoffice.com/login/common/oauth/authorize'       ); /* SuperOffice SuperID Oauth Login URL */
...
define('PRIVATE_KEY', dirname(__FILE__).'/certificates/private.pem');
...
define('REDIRECT_CALLBACK', 'https://soapps.sample.dk/callback');

define('CALLBACK_REDIRECT', 'https://soapps.sample.dk/sampleapp');
