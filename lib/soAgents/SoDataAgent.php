...
class SoDataAgent extends SoAgent
{
    ...
    {
        parent::__construct($endpoint."data.svc", "WcfData.wsdl", $ticket, $applicationToken, $headerNamespace, $timeout, $responseTimeout, $portName);
    }
    /**
     * Not implemented
     * 
