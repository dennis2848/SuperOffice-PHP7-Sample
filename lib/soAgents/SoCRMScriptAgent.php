...
/**
 * SoCRMScriptAgent short summary.
 *
 *  
 *
 * @version 1.0
...
class SoCRMScriptAgent extends SoAgent
{
    ...
    {
        parent::__construct($endpoint."crmscript.svc", "WcfCRMScript.wsdl", $ticket, $applicationToken, $headerNamespace, $timeout, $responseTimeout, $portName);
    }
    /**
     * Not implemented
     * 
