...
/**
 * SoPrincipalAgent short summary.
 *
 *  
 *
 * @version 1.0
...
class SoPrincipalAgent extends SoAgent
{
    ...
    {
        parent::__construct($endpoint."Principal.svc", "WcfPrincipal.wsdl", $ticket, $applicationToken, $headerNamespace, $timeout, $responseTimeout, $portName);
    }
    /**
     * Not implemented
     * 
