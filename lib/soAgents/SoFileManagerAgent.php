...
/**
 * SoFileManagerAgent short summary.
 *
 *  
 *
 * @version 1.0
...
class SoFileManagerAgent extends SoAgent
{
    ...
    {
        parent::__construct($endpoint."filemanager.svc", "WcfFileManager.wsdl", $ticket, $applicationToken, $headerNamespace, $timeout, $responseTimeout, $portName);
    }
    /**
     * Not implemented
     * 
